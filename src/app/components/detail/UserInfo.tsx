...
function UserInfo() {
  ...
  const activeUserArr = users?.filter((user) => user.login === user_id);
    ...
    <section className="flex flex-col gap-8 pl-16 pt-5">
      <div className="flex items-center gap-8 ">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-white font-bold text-[32px] leading-[24px]">
            {activeUser?.login}
          </h1>
      ...
      <div className="flex items-center gap-10  font-mono">
        <div className="flex flex-col gap-4 duration-1000">
          <a className="w-50" href={activeUser?.html_url}>
            <InvertButton content="Github Profile" />
          </a>
          <a className="w-40" href={activeUser?.url}>
            <LitupButton content="Profile Info" />
          </a>
